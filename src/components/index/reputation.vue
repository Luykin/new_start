  ...
  <transition name="list">
    <div class="detail-body">
      ...
      <div class="task-info flex fw">
        ...
        <div class="s line-font">1、信用极差：150</div>
        <div class="s line-font">2、信用极低：200</div>
        ...
        <div class="s line-font">1、抖赞信用低于<i class="red-color">200</i>，每天只能报名<i class="red-color">2次</i>任务；</div>
        <div class="s line-font">2、抖赞信用低于<i class="red-color">150</i>，不能提现与充值, 不能报名发布任务；</div>
        <div class="s line-font line-min-title">信用分数增加：</div>
        <div class="s line-font">1、每日签到,增加信誉<i class="red-color">+1</i>；</div>
        <div class="s line-font">2、报名任务完成并审核通过<i class="red-color">+1</i>(每日1次)；</div>
        <div class="s line-font">3、发布任务并全部审核通过, 无仲裁<i class="red-color">+2</i>(每日1次)；</div>
